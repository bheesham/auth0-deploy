...
/**
 * Auth0 Post Login Action Handler for SAML Mappings
...
exports.onExecutePostLogin = async (event, api) => {
  ...
  switch (event.client.client_id) {
    ...
    case "cEfnJekrSStxxxBascTjNEDAZVUPAIU2": // stripe-subplat
      ...
      Object.keys(groupToStripeRoleMap).forEach((groupName) => {
        if (
          ...
          (/** @type {any} */ (groupToStripeRoleMap))[groupName].forEach((/** @type {any} */ roleInfo) => {
            api.samlResponse.setAttribute(
    ...
    case "x7TF6ZtJev4ktoHR4ObWmA9KeqGni6rq": // Braintree
      ...
      api.samlResponse.setAttribute("roles", (event.user.app_metadata?.groups || []).join(","));
      break;
  }
